...
namespace pix
{
	...
	// 
	// Philosophy:
	// TriangleMesh2DRenderer2D focuses on performant rendering of the supported 2D objects.
	...
	public:
		...
		TriangleMesh2DRenderer2D(int initialVertexBatchCapacity = 100000);
	...
	private:
		...
		std::vector<Vec2> worldPositionBuffer_; // Stores current world-space vertex positions
		std::vector<Vec2> prevWorldPositionBuffer_; // Stores previous world-space vertex positions
	};
