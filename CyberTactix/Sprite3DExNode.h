...
namespace pix
{
	...
	// 
	// Philosophy:
	// Sprite3DExNode is the most complete foundational hierarchical renderable 3D entity that can move through space. 
	...
	public:
		...
		bool SetParent(Sprite3DExNode* newParent);
	...
	private:
		...
		Sprite3DExNode* parent_ = nullptr;
